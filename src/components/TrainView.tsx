...
class TrainView extends Component<MarkViewProps, MarkViewState>{
	...
	public render(): JSX.Element {
		const { labels, inputVisible, labelSettingConfig, popoverVisibleName, selectedRowKeys } = this.state
	...
	public componentDidMount() {
        ...
        const { data, updateMarkTextData } = this.props
